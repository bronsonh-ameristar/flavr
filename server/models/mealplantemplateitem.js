...
module.exports = (sequelize, DataTypes) => {
  class MealPlanTemplateItem extends Model {
    static associate(models) {
      MealPlanTemplateItem.belongsTo(models.MealPlanTemplate, {
        foreignKey: 'templateId',
        as: 'template'
      });
      MealPlanTemplateItem.belongsTo(models.Meal, {
        foreignKey: 'mealId',
        as: 'meal'
      });
    }
  ...
  MealPlanTemplateItem.init({
    ...
    sequelize,
    modelName: 'MealPlanTemplateItem'
  });
